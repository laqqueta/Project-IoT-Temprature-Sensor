...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        # lcd1.setStyleSheet("""QLCDNumber {background-color: #1A0000;}""")
        lcd2.setDigitCount(10)
        # lcd2.setStyleSheet("""QLCDNumber {background-color: #1A0000;}""")
        ...
        self.setWindowTitle('Kitchen Temprature')
...
class DataThread(QThread):
    ...
    broker_address = "192.168.238.22"
    port = 1883
    user = "mbkm"
    password = "mbkm"

    client = mqtt.Client("Project UAS : Gamzv")
